...
export function BoothStatusIndicator() {
    ...
    return (
        <div className="fixed top-6 right-6 z-50 flex items-center gap-3 bg-black/40 backdrop-blur-md px-3 py-2 rounded-full border border-white/10 shadow-lg transition-all duration-300 hover:bg-black/60">
            {/* Connection Status */}
            <div
